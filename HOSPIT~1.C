/*	
	This is a program on the project "Hospital Management System" where the user can:
	1. Add a new patient record
	2. Search or edit patient record
	3. Know the list of patient records
	4. Delete patient records

	Made By: Anuj Nandal from JIMS VK-II of IT Department 1st Semester
	On: 28-02-2021
*/
...
//Declaring pointers for file handling operations
FILE *fp, *fp1, *f1, *f2;
int s, z;
char fn1[] = "opd12.patient";
char fn2[] = "oopd12.patient";

//Declaring structure for common variables
struct hospital
{
...
void main()
{
	...
	clrscr();
	//Calling mainscreen function for the main menu
	mainscreen();
label3:
	textcolor(3);
	gotoxy(23, 13);
	...
	//Calling mainscreen function again for the main menu after clearing the screen
	mainscreen();
label1:
	...
	//Starting the switch case for various options of the main menu
	switch (d)
	{
	case '1':
	{
	...
	{
		clrscr();
		//Calling functions for edit menu
		mainscreen();
		editrecord();
		break;
	}
	...
	label6:
		...
		gotoxy(22, 19);
		cprintf("3.Records of O.P.D. patients");
		gotoxy(22, 21);
		cprintf("4.Records in paricular date");
		gotoxy(22, 23);
		...
		case '1':
		{
			...
			gotoxy(4, 20);
			textcolor(11);
			cprintf("Ready to Display patient records according to alphabatecal order of names");
			gotoxy(27, 24);
			textcolor(3);
			cprintf("Press");
			textcolor(15 + 128);
...
//Function for adding new specialist
void newrecord1()
{
	char q;
	fflush(stdin);
...
//Function for displaying various departments
void displaydepartment()
{
	int i;
	gotoxy(48, 11);
...
//Function for displaying the amounts of records
void edit1()
{
	int i, k;
	gotoxy(10, 22);
	...
	if (p.totalfee > p.balance)
	{
		...
		textcolor(15);
		cprintf("Rs.%0.2f", p.totalfee - p.balance);
	}
	else
	{
		textcolor(11);
		...
		textcolor(15);
		cprintf("Rs.%0.2f", p.balance - p.totalfee);
	}
}

//Function for the edit menu
void switch1()
{
	int x, i;
	float d, lk;
...
label2:
	...
	case 4:
	{
		...
		gotoxy(45, 13);
		textcolor(3);
		cprintf("Type `esc' in content to stop");
		gotoxy(45, 15);
		textcolor(15);
		cprintf("Contents");
		gotoxy(70, 15);
...
//Function for asking to go to the edit menu
void editrecord()
{
	int y, x;
	gotoxy(18, 20);
	...
	while (fread(&p, sizeof(p), 1, fp))
	{
		if ((p.sn == y) || (strcmp(p.name, string) == 0))
		{
			...
			gotoxy(13, 24);
			textcolor(9);
			printf("Press `1' to edit or add and any key to go to main menu");
			fflush(stdin);
			gotoxy(70, 24);
			scanf("%d", &x);
			if (x == 1)
...
//Function for displaying the various test and their prices
void displaytest()
{
	int i;
	gotoxy(50, 10);
